...
import { ProductActions, StarRating } from '@/components/shopnepal/product-actions';
    ...
    <>
      ...
      <main>
        ...
        <div className="service"><div className="container"><div className="service-container">
          <div className="service-item"><div className="service-icon"><IonIcon name="boat-outline" /></div><div><p className="service-title">Worldwide Delivery</p><p className="service-desc">For Order Over Rs. 13,000</p></div></div>
          <div className="service-item"><div className="service-icon"><IonIcon name="rocket-outline" /></div><div><p className="service-title">Next Day delivery</p><p className="service-desc">Nepal Orders Only</p></div></div>
          <div className="service-item"><div className="service-icon"><IonIcon name="call-outline" /></div><div><p className="service-title">Best Online Support</p><p className="service-desc">Hours: 8AM - 11PM</p></div></div>
        </div></div></div>
      </main>
      <Footer/>
    </>
