...
// modal eventListener
// Guarded: these regions are optional on pages that reuse this script.
...
for (let i = 0; i < mobileMenuOpenBtn.length; i++) {
  ...
  // The menus themselves are generated by nav.js after this runs, so the
  // close buttons may not exist yet - nav.js binds those once it has rendered.
